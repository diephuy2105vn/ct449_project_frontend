...
<template>
    <TitleBlock :title="'Cập Nhật Sách'" />
...
export default {
    ...
    async created() {
        ...
        this.companyId = book.publishingCompany._id;
    ...
    methods: {
        ...
        async submitForm() {
            ...
            try {
                const res = await BookService.update(this.id, formData);
                this.$router.push("/books");
            } catch (error) {
                console.log(error.message);
                alert("Cập nhật sách thất bại đã có lỗi xảy ra");
            }
        },
    },
};
